        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                ...
                <form action="<?php echo e(route("guardarVuelo")); ?>" method="POST">
                    ...
                    <br>
                    <div class="form-group">
                        <a class="btn btn-warning" href="<?php echo e(route("vuelos")); ?>">Volver</a>
...
</html><?php /**PATH C:\Users\UNAH-IS\Desktop\examen_allam\resources\views/nuevoVuelo.blade.php ENDPATH**/ ?>