...
<body>
    ...
    <br>
    <a class="btn btn-success" href="{{route("agregarTipoAsiento")}}">Agregar Nuevo</a>
    <br>
    <table class="table">
        <thead>
            <tr>
        ...
        <tbody>
                ...
                @foreach ($tiposAsientos as $tipoAsiento)
                   <tr>
                    ...
                    <td>
                        <a href="{{route("editarTipoAsiento", $tipoAsiento->idTipoAsiento)}}">Editar</a>
                    </td>
                    <td>
                        <a href="{{route("eliminarTipoAsiento", $tipoAsiento->idTipoAsiento)}}">Eliminar</a>
                    </td>
                   </tr>
                @endforeach
